 ...
 */
export const SigningAlgorithmListSlim = [
    ECDSA,
];
/**
 ...
 */
export const EncryptionAlgorithmListSlim = [];
/**
 ...
 */
export const CryptoAlgorithmListSlim = [
