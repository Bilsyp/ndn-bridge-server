...
import { Encoder, EvDecoder, StructBuilder, StructFieldEnum, StructFieldNNI, StructFieldNNIBig, StructFieldText, StructFieldType } from "@ndn/tlv";
import { CsFlags, FaceFlags, FacePersistency, FaceScope, LinkType, RouteFlags, TT } from "./an-nfd_browser.js";
const timeFmt = new Intl.DateTimeFormat([], { dateStyle: "medium", timeStyle: "medium" });
const StructFieldTimestamp = {
    ...StructFieldNNI,
...
export class GeneralStatus extends buildGeneralStatus.baseClass() {
    static datasetName = "status/general";
    /** Uptime in milliseconds. */
    get uptime() {
        return this.currentTimestamp - this.startTimestamp;
    }
}
buildGeneralStatus.subclass = GeneralStatus;
...
export class FaceStatus extends buildFaceStatus.baseClass() {
    static datasetName = "faces/list";
}
buildFaceStatus.subclass = FaceStatus;
...
export class ChannelStatus extends buildChannelStatus.baseClass() {
    static datasetName = "faces/channels";
}
buildChannelStatus.subclass = ChannelStatus;
...
export class CsInfo extends buildCsInfo.baseClass() {
    static datasetName = "cs/info";
}
buildCsInfo.subclass = CsInfo;
...
export class StrategyChoice extends buildStrategyChoice.baseClass() {
    static datasetName = "strategy-choice/list";
}
buildStrategyChoice.subclass = StrategyChoice;
...
export class Route extends buildRoute.baseClass() {
}
...
export class RibEntry extends buildRibEntry.baseClass() {
    static datasetName = "rib/list";
}
